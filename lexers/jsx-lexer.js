...
var JavascriptLexer = /*#__PURE__*/ (function (_BaseLexer) {
    function JavascriptLexer() {
        ...
        _this.namespaceFunctions = options.namespaceFunctions || ["useTranslation", "withTranslation"];

        _this.attr = options.attr || "i18nKey";
        _this.parseGenerics = options.parseGenerics || false;
        _this.typeMap = options.typeMap || {};
        _this.translationFunctionsWithArgs = {};
        return _this;
    }
    _inherits(JavascriptLexer, _BaseLexer);
    return _createClass(JavascriptLexer, [
        {
            ...
            value: function createCommentNodeParser() {
                ...
                return function (keys, node, content) {
                    ts.forEachLeadingCommentRange(content, node.getFullStart(), function (pos, end, kind) {
        ...
        },
        {
            ...
            value: function setNamespaces(keys) {
                ...
                return keys.map(function (entry) {
                    var _ref, _entry$ns, _this3$translationFun;
                    var namespace =
                        (_ref =
                            (_entry$ns = entry.ns) !== null && _entry$ns !== void 0
                                ? _entry$ns
                                : (_this3$translationFun = _this3.translationFunctionsWithArgs) === null ||
                                    _this3$translationFun === void 0 ||
                                    (_this3$translationFun = _this3$translationFun[entry.functionName]) === null ||
                                    _this3$translationFun === void 0
                                  ? void 0
                                  : _this3$translationFun.ns) !== null && _ref !== void 0
                            ? _ref
        ...
        },
        {
            ...
            value: function setKeyPrefixes(keys) {
                ...
                return keys.map(function (_ref2) {
                    var _this4$translationFun, _this4$translationFun2;
                    var functionName = _ref2.functionName,
                        key = _objectWithoutProperties(_ref2, _excluded);
                    var keyPrefix =
                        (_this4$translationFun =
                            (_this4$translationFun2 = _this4.translationFunctionsWithArgs) === null ||
                            _this4$translationFun2 === void 0 ||
                            (_this4$translationFun2 = _this4$translationFun2[functionName]) === null ||
                            _this4$translationFun2 === void 0
                                ? void 0
                                : _this4$translationFun2.keyPrefix) !== null && _this4$translationFun !== void 0
                            ? _this4$translationFun
                            : _this4.keyPrefix;
                    return keyPrefix
                        ? _objectSpread(
        ...
        {
            key: "variableDeclarationExtractor",
            value: function variableDeclarationExtractor(node) {
                var _node$name$elements, _ref3, _firstDeconstructedPr, _firstDeconstructedPr2, _node$initializer$exp;
                var firstDeconstructedProp =
                    (_node$name$elements = node.name.elements) === null || _node$name$elements === void 0
                        ? void 0
                        : _node$name$elements[0];
                if (
                    ((_ref3 =
                        (_firstDeconstructedPr =
                            firstDeconstructedProp === null || firstDeconstructedProp === void 0
                                ? void 0
                                : firstDeconstructedProp.propertyName) !== null && _firstDeconstructedPr !== void 0
                            ? _firstDeconstructedPr
                            : firstDeconstructedProp === null || firstDeconstructedProp === void 0
                              ? void 0
                              : firstDeconstructedProp.name) === null || _ref3 === void 0
                        ? void 0
                        : _ref3.escapedText) === "t" &&
                    this.functions.includes(
                        firstDeconstructedProp === null ||
                            firstDeconstructedProp === void 0 ||
                            (_firstDeconstructedPr2 = firstDeconstructedProp.name) === null ||
                            _firstDeconstructedPr2 === void 0
                            ? void 0
                            : _firstDeconstructedPr2.escapedText
                    ) &&
                    this.namespaceFunctions.includes(
                        (_node$initializer$exp = node.initializer.expression) === null ||
                            _node$initializer$exp === void 0
                            ? void 0
                            : _node$initializer$exp.escapedText
                    )
                ) {
                    var _firstDeconstructedPr3;
                    this.translationFunctionsWithArgs[firstDeconstructedProp.name.escapedText] = {
                        pos: node.initializer.pos,
                        storeGlobally: !(
                            (_firstDeconstructedPr3 = firstDeconstructedProp.propertyName) !== null &&
                            _firstDeconstructedPr3 !== void 0 &&
                            _firstDeconstructedPr3.escapedText
                        ),
                    };
                }
            },
        },
        {
            ...
            value: function extract(content) {
                var _this5 = this;
                var filename = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "__default.js";
                var keys = [];
        ...
        },
        {
            ...
            value: function functionParamExtractor(node) {
                ...
                if (
                    ...
                    if (typeArguments && typeArguments.length && typeArguments[0].kind === ts.SyntaxKind.LiteralType) {
        ...
        },
        {
            ...
            value: function expressionExtractor(node) {
                ...
                var functionDefinition = Object.entries(this.translationFunctionsWithArgs).find(function (_ref4) {
                    var _ref5 = _slicedToArray(_ref4, 2),
                        name = _ref5[0],
                        translationFunc = _ref5[1];
                    return (
                        (translationFunc === null || translationFunc === void 0 ? void 0 : translationFunc.pos) ===
                        node.pos
                    );
                });
                var storeGlobally =
                    (_functionDefinition$ =
                        functionDefinition === null || functionDefinition === void 0
                            ? void 0
                            : functionDefinition[1].storeGlobally) !== null && _functionDefinition$ !== void 0
                        ? _functionDefinition$
                        : true;
                ...
                if (isNamespaceFunction && node.arguments.length) {
                    ...
                    var namespace = namespaces.find(function (ns) {
                        return (
                    ...
                    if (!namespace) {
                        ...
                        this.emit(
                            ...
                            namespaceArgument.kind === ts.SyntaxKind.Identifier
                                ? "Namespace is not a string literal nor an array containing a string literal: ".concat(
                    ...
                    if (optionsArgument && optionsArgument.kind === ts.SyntaxKind.ObjectLiteralExpression) {
                        var keyPrefixNode = optionsArgument.properties.find(function (p) {
                ...
                if (isTranslationFunction) {
                    ...
                    if (
                        ...
                        if (!concatenatedString) {
                            this.emit("warning", "Key is not a string literal: ".concat(keyArgument.text));
                            return null;
                        }
                    ...
                    } else if (_optionsArgument && _optionsArgument.kind === ts.SyntaxKind.BinaryExpression) {
                        var _concatenatedString = this.concatenateString(_optionsArgument);
                        if (!_concatenatedString) {
                            this.emit(
                                "warning",
                                "Default value is not a string literal: ".concat(_optionsArgument.text)
                            );
                            return null;
                        }
                    ...
                    if (_optionsArgument && _optionsArgument.kind === ts.SyntaxKind.ObjectLiteralExpression) {
                        var _iterator2 = _createForOfIteratorHelper(_optionsArgument.properties),
                            _step2;
                        try {
                            for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
                                ...
                                if (p.kind === ts.SyntaxKind.SpreadAssignment) {
                                    this.emit(
                                        "warning",
                                        "Options argument is a spread operator : ".concat(p.expression.text)
                                    );
                ...
                var isTranslationFunctionCreation =
                    node.expression.escapedText && this.namespaceFunctions.includes(node.expression.escapedText);
                if (isTranslationFunctionCreation) {
                    this.translationFunctionsWithArgs[
                        functionDefinition === null || functionDefinition === void 0 ? void 0 : functionDefinition[0]
                    ] = entries[0];
                }
                return null;
            },
        ...
        {
            key: "expressionToName",
            value: function expressionToName(expression) {
                if (expression) {
                    if (expression.text) {
                        return expression.text;
                    } else if (expression.name) {
                        return [this.expressionToName(expression.expression), this.expressionToName(expression.name)]
                            .filter(function (s) {
                                return s && s.length > 0;
                            })
                            .join(".");
